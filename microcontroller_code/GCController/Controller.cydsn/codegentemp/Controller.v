// ======================================================================
// Controller.v generated from TopDesign.cysch
// 05/24/2020 at 12:44
...
module top ;
	...
	wire [0:0] tmpOE__Controller1_net;
	wire [0:0] tmpFB_0__Controller1_net;
	wire [0:0] tmpINTERRUPT_0__Controller1_net;
	electrical [0:0] tmpSIOVREF__Controller1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		Controller1
		 (.oe(tmpOE__Controller1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Controller1_net[0:0]}),
		  .io({Net_23}),
		  .siovref(tmpSIOVREF__Controller1_net),
		  .interrupt({tmpINTERRUPT_0__Controller1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Controller1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Controller2_net;
	wire [0:0] tmpFB_0__Controller2_net;
	wire [0:0] tmpINTERRUPT_0__Controller2_net;
	electrical [0:0] tmpSIOVREF__Controller2_net;

	cy_psoc3_pins_v1_10
		#(.id("acb65af1-5ac7-4835-b73b-a58939a6e581"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Controller2
		 (.oe(tmpOE__Controller2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Controller2_net[0:0]}),
		  .io({Net_24}),
		  .siovref(tmpSIOVREF__Controller2_net),
		  .interrupt({tmpINTERRUPT_0__Controller2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Controller2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
